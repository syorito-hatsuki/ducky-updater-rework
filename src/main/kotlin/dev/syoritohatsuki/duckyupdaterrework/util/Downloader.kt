...
suspend fun downloadFileWithProgress(url: String, outputFile: String) {
    ...
    val job = CoroutineScope(Dispatchers.IO).launch {
        ...
        val outputStream = Files.newOutputStream(FabricLoader.getInstance().gameDir.resolve("mods").resolve(outputFile))
